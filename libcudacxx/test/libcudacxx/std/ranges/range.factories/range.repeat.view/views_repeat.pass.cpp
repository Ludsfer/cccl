...
struct EqualTo33 {
  __host__ __device__ constexpr bool operator()(int i) const { return i == 33; }
};

struct Add3 {
  __host__ __device__ constexpr int operator()(int i) const { return i + 3; }
};
...
__host__ __device__ constexpr bool test() {
  ...
  static_assert(cuda::std::same_as<decltype(cuda::std::views::repeat(42, 3)), cuda::std::ranges::repeat_view<int, int>>);
