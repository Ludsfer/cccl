...
private:
  _LIBCUDACXX_NO_UNIQUE_ADDRESS __movable_box<_Tp> __value_;
  _LIBCUDACXX_NO_UNIQUE_ADDRESS _Bound __bound_ = _Bound();
};
...
struct __fn {
  template <class _Tp>
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Tp&& __value) const
    noexcept(noexcept(ranges::repeat_view(_CUDA_VSTD::forward<_Tp>(__value))))
    -> decltype(      ranges::repeat_view(_CUDA_VSTD::forward<_Tp>(__value)))
    { return          ranges::repeat_view(_CUDA_VSTD::forward<_Tp>(__value)); }


  template <class _Tp, class _Bound>
  _LIBCUDACXX_NODISCARD_EXT _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Tp&& __value, _Bound&& __bound_sentinel) const
    noexcept(noexcept(ranges::repeat_view(_CUDA_VSTD::forward<_Tp>(__value), _CUDA_VSTD::forward<_Bound>(__bound_sentinel))))
    -> decltype(      ranges::repeat_view(_CUDA_VSTD::forward<_Tp>(__value), _CUDA_VSTD::forward<_Bound>(__bound_sentinel)))
