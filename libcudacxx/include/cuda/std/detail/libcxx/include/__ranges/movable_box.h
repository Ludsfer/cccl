...
{
  _LIBCUDACXX_NO_UNIQUE_ADDRESS __mb_holder<_Tp> __holder_;
...
struct __mb_copy_assign<_Tp, false> : __mb_holder_base<_Tp>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __mb_copy_assign&
...
struct __mb_move_assign<_Tp, false> : __mb_copy_assign<_Tp>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __mb_move_assign&
