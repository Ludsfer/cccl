...
public:
  ...
  _CCCL_HOST_DEVICE exception_ptr(const exception_ptr&) noexcept;
  _CCCL_HOST_DEVICE exception_ptr& operator=(const exception_ptr&) noexcept;
  _CCCL_HOST_DEVICE ~exception_ptr() noexcept;
...
class _LIBCUDACXX_EXCEPTION_ABI exception_ptr {
  _CCCL_DIAG_PUSH
  _CCCL_DIAG_SUPPRESS_CLANG("-Wunused-private-field")
  void* __ptr1_;
  void* __ptr2_;
  _CCCL_DIAG_POP
...
public:
  _CCCL_HOST_DEVICE exception_ptr() noexcept;
  _CCCL_HOST_DEVICE exception_ptr(nullptr_t) noexcept;
  _CCCL_HOST_DEVICE exception_ptr(const exception_ptr& __other) noexcept;
  _CCCL_HOST_DEVICE exception_ptr& operator=(const exception_ptr& __other) noexcept;
  _CCCL_HOST_DEVICE exception_ptr& operator=(nullptr_t) noexcept;
  _CCCL_HOST_DEVICE ~exception_ptr() noexcept;
  _CCCL_HOST_DEVICE explicit operator bool() const noexcept;
};
...
// information.
template <class _E>
_CCCL_HOST_DEVICE void* __GetExceptionInfo(_E);
